  ...
  return (
    <div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Card: Presenças */}
        <Link href="/dashboard/student/attendance" className="block">
        ...
        {/* Card: Atividades */}
        <Link href="/dashboard/student/activities" className="block">
          <article className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
            <div className="flex items-center justify-between">
          ...
          <article className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
            ...
            <div className="mt-4">
              <p className="text-sm text-gray-600 mb-1">
                Pendentes: <span className="font-medium text-red-600">{paymentsSummary.pending}</span>
              </p>
              <p className="text-sm text-gray-600">
                Último pagamento: <span className="font-medium">{paymentsSummary.lastPaymentDate}</span>
              </p>
            </div>
      ...
      <div className="mt-8 bg-white shadow rounded-lg p-6">
        <div className="flex items-center justify-between">
          ...
          <Link href="/dashboard/student/chatbot" className="text-sm text-blue-600">
            Abrir
          </Link>
        </div>
