...
export default function TeacherDashboardPage() {
  const teacherName = "Carlos Pereira";
  ...
  return (
    <div>
      <header className="mb-6">
        <h1 className="text-3xl font-bold">Bem-vindo, {teacherName}</h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <article className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
            ...
            <div className="mt-4 space-y-1">
              <p className="text-sm text-gray-600">
                Alunos presentes: <span className="font-medium">{presenceSummary.today}</span> / {presenceSummary.totalStudents}
              </p>
              <p className="text-sm text-gray-600">
        ...
        {/* Card: Atividades */}
        <Link href="/dashboard/teacher/activities" className="block">
          <article className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
            <div className="flex items-center justify-between">
        ...
        <Link href="/dashboard/teacher/students" className="block">
          <article className="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
            ...
            <div className="mt-4 space-y-1">
              ...
              <p className="text-sm text-gray-600">
                Ausências hoje: <span className="font-medium text-red-600">{studentsSummary.absentsToday}</span>
              </p>
            </div>
      ...
      <div className="mt-8 bg-white shadow rounded-lg p-6">
        <div className="flex items-center justify-between">
          ...
          <Link href="/dashboard/teacher/chatbot" className="text-sm text-blue-600">
            Abrir
          </Link>
        </div>
